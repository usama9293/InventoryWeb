...
namespace inventory.DataAccess.Migrations
{
    ...
    public partial class intialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Author", "CategoryId", "Description", "ISBN", "Price", "Price100", "Price50", "Title", "listPrice" },
                values: new object[,]
                {
                    { 1, "Sun Tzu", 1, "A book on military strategy", "1234567890", 120, 80, 100, "The Art of War", 150 },
                    { 2, "George Orwell", 2, "Dystopian novel by George Orwell", "2345678901", 140, 90, 110, "1984", 180 }
                });
